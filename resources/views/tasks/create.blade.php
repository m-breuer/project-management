...
@section('heading')
    ...
    <div class="ms-auto btn-group">
        <a href="{{ route("project.show", $project) }}" target="_self" class="btn btn-dark">{{ __("Show Project") }}</a>
    </div>
@endsection

@section('content')
    <form class="row g-2" method="POST" action="{{ route("project.task.store", $project) }}">
        @method("POST")
        @csrf
